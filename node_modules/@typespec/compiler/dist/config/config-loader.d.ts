 ...
 */
export declare function findTypeSpecConfigPath(host: CompilerHost, path: string): Promise<string | undefined>;
/**
 * Load the typespec configuration for the provided path or directory
 * @param host
 * @param path
 */
export declare function loadTypeSpecConfigForPath(host: CompilerHost, path: string, errorIfNotFound?: boolean): Promise<TypeSpecConfig>;
/**
