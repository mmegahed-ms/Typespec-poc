...
async function main() {
    ...
    await yargs(process.argv.slice(2))
        ...
        return cmd
            ...
            .option("config", {
            type: "string",
            describe: "The path to a TypeSpec config YAML file. If a folder is specified, the CLI will attempt to search for 'tspconfig.yaml' by moving up the folder hierarchy. Defaults to {cwd}.",
        })
