...
public class Gadget implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new Gadget and sets the default values.
     * @return a void
     */
    ...
    public static Gadget createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("color", (n) -> { this.setColor(n.getEnumValue(GadgetColor.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setColor(@javax.annotation.Nullable final GadgetColor value) {
        this.color = value;
    }
    /**
