...
public class GadgetCreateOrUpdate implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The color property */
    private GadgetCreateOrUpdateColor color;
    /** The weight property */
     ...
     * @return a GadgetCreateOrUpdate
     */
    @javax.annotation.Nonnull
    public static GadgetCreateOrUpdate createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a GadgetCreateOrUpdateColor
     */
    @javax.annotation.Nullable
    public GadgetCreateOrUpdateColor getColor() {
        return this.color;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("color", (n) -> { this.setColor(n.getEnumValue(GadgetCreateOrUpdateColor.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setColor(@javax.annotation.Nullable final GadgetCreateOrUpdateColor value) {
        this.color = value;
    }
    /**
