...
using System;
namespace ApiSdk.Widgets.Item.Analyze {
    /// <summary>
    ...
    public class AnalyzeRequestBuilder : BaseRequestBuilder {
        ...
        public AnalyzeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/widgets/{id}/analyze", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyzeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalyzeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/widgets/{id}/analyze", rawUrl) {
        }
