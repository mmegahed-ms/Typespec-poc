...
using System;
namespace ApiSdk.Customers.Item.Analyze {
    /// <summary>
    ...
    public class AnalyzeRequestBuilder : BaseRequestBuilder {
        ...
        public AnalyzeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/customers/{id}/analyze", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyzeRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AnalyzeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/customers/{id}/analyze", rawUrl) {
        }
